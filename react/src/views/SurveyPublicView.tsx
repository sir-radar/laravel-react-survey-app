...
import { Question, Survey } from "../models/stateModels";
...
export default function SurveyPublicView() {
  ...
  function answerChanged(question: Question, value: string) {
      ...
      {!loading && (
        <form onSubmit={(ev) => onSubmit(ev)} className="container mx-auto p-4">
          <div className="grid grid-cols-6">
            <div className="mr-4">
              <img src={survey.image_url as string} alt="" />
            </div>
