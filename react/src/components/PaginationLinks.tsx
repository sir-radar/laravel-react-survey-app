...
interface Props {
  onPageClick: (link: any) => void;
  meta: any;
}

export default function PaginationLinks({ meta, onPageClick }: Props) {
  function onClick(ev: React.MouseEvent<HTMLAnchorElement>, link: any) {
    ev.preventDefault();
    if (!link.url) {
      return;
    }
        ...
        <div>
          {meta.total > meta.per_page && (
            ...
            >
              ...
              {meta.links &&
                meta.links.map((link: any, ind: any) => (
                  <a
                    href="#"
